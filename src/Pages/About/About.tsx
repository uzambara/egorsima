  ...
  return (
    <main className={className}>
      ...
      <section className={styles.aboutMe}>
        ...
        <h4>Life</h4>
        <p>
          Besides work I am raising two children. I like snowboarding and motorcycles. I traveled a lot on a motorcycle
          in Russia. I was on Elbrus and Sochi mountains. I also love rock music and rock festivals.
        </p>
      </section>
